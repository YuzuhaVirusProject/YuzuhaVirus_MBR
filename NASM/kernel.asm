...
load:
	...
	mov al, 0x13 ; 320x200, 128 colors
	int 0x10
	...
	mov cl, 16        ; Set color index 32 in VGA palette
...
draw_loop:
	...
	cmp di, 0xFFF3  ; Check if index went out of bounds
	jne draw_loop   ; Continue if ended

	mov di, 320*200-1 ; Reset index
	cmp cl, 20        ; Check if above color index 51 in VGA palette
	jg .rainbow_end
